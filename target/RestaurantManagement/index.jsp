		...
		<div id="wrapper" class="container">
			<section class="navbar main-menu">
				<div class="navbar-inner main-menu">				
					<a href="index.html" class="logo pull-left"><img src="themes/images/logo_2.png" class="site_logo" alt=""></a>
					<nav id="menu" class="pull-right">
						<ul>
							<li><a href="./products.html">All foods</a></li>																					
				...
				<div class="row">
					<div class="span12">													
						<div class="row">
							<div class="span12">
								<h4 class="title">
									<span class="pull-left"><span class="text"><span class="line"><strong>Japanese</strong> Foods</span></span></span>
											...
											<ul class="thumbnails">												
												<li class="span3">
													<div class="product-box">
														...
														<p><a href="product_detail.html"><img src="themes/images/1.png" alt="" /></a></p>
												...
												<li class="span3">
													<div class="product-box">
														<span class="sale_tag"></span>
														<p><a href="product_detail.html"><img src="themes/images/2.png" alt="" /></a></p>
												...
												<li class="span3">
													<div class="product-box">
														<p><a href="product_detail.html"><img src="themes/images/3.png" alt="" /></a></p>
												...
												<li class="span3">
													<div class="product-box">
														<p><a href="product_detail.html"><img src="themes/images/4.png" alt="" /></a></p>
